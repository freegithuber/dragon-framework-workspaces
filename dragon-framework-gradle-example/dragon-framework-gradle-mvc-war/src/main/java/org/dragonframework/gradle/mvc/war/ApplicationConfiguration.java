...
public class ApplicationConfiguration {
     ...
     */
    @Bean
    public Docket gradleMvcWarDocket(final ApplicationProperties applicationProperties) {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("dragon-framework-gradle-mvc-war")
            .description("dragon-framework-gradle-mvc-war documents")
            .version("1.0.0-SNAPSHOT")
            .build();

        Docket docket = new Docket(DocumentationType.SWAGGER_2)
            .groupName("dragon-framework-gradle-mvc-war")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("org.dragonframework.gradle.mvc.war"))
