 ...
 */
package org.dragonframework.gradle.mvc.jar;
...
public class ApplicationConfiguration {
     ...
     */
    @Bean
    public Docket gradleMvcJarDocket(final ApplicationProperties applicationProperties) {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("dragon-framework-gradle-mvc-jar")
            .description("dragon-framework-gradle-mvc-jar documents")
            .version("1.0.0-SNAPSHOT")
            .build();

        Docket docket = new Docket(DocumentationType.SWAGGER_2)
            .groupName("dragon-framework-gradle-mvc-jar")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("org.dragonframework.gradle.mvc.jar"))
