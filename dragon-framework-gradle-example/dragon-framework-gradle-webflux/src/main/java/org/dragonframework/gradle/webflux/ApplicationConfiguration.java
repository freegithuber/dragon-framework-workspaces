 ...
 */
package org.dragonframework.gradle.webflux;
...
public class ApplicationConfiguration {
     ...
     */
    @Bean
    public Docket gradleWebfluxDocket(final ApplicationProperties applicationProperties) {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("dragon-framework-gradle-webflux")
            .description("dragon-framework-gradle-webflux documents")
            .version("1.0.0-SNAPSHOT")
            .build();

        Docket docket = new Docket(DocumentationType.SWAGGER_2)
            .groupName("dragon-framework-gradle-webflux")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("org.dragonframework.gradle.webflux"))
