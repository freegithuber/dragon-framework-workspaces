 ...
 */
package org.dragonframework.maven.mvc.war;
...
public class ApplicationConfiguration {
     ...
     */
    @Bean
    public Docket mavenMvcWarDocket(final ApplicationProperties applicationProperties) {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("dragon-framework-maven-mvc-war")
            .description("dragon-framework-maven-mvc-war documents")
            .version("1.0.0-SNAPSHOT")
            .build();

        Docket docket = new Docket(DocumentationType.SWAGGER_2)
            .groupName("dragon-framework-maven-mvc-war")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("org.dragonframework.maven.mvc.war"))
