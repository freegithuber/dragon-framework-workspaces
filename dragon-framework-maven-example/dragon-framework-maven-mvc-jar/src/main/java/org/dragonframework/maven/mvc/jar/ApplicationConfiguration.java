 ...
 */
package org.dragonframework.maven.mvc.jar;
...
public class ApplicationConfiguration {
     ...
     */
    @Bean
    public Docket mavenMvcJarDocket(final ApplicationProperties applicationProperties) {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("dragon-framework-maven-mvc-jar")
            .description("dragon-framework-maven-mvc-jar documents")
            .version("1.0.0-SNAPSHOT")
            .build();

        Docket docket = new Docket(DocumentationType.SWAGGER_2)
            .groupName("dragon-framework-maven-mvc-jar")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("org.dragonframework.maven.mvc.jar"))
